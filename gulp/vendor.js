...
module.exports = {
    minified : {
        ...
        css : [
            ...
            paths.destination.vendor.css + '/ladda.min.css',
        ...
        js : [
            ...
            paths.destination.vendor.js + '/spin.min.js',
            paths.destination.vendor.js + '/ladda.min.js',
            ...
            paths.destination.vendor.js + '/angular-ladda.min.js',
    ...
    unminified : {
        ...
        js : [
            ...
            paths.destination.vendor.js + '/angular-ladda.js',
