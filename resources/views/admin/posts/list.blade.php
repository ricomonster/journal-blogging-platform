...
@section('content')
<div id="posts_list_page" v-cloak>
    ...
    <section class="post-lists">
        ...
        <section class="lists-wrapper">
            <posts-list :posts.sync="posts" :active.sync="active" :loading="loading"></posts-list>
        </section>
    </section>
    <section class="post-preview">
        ...
        <section class="preview-content" v-if="!loading && active.id">
            ...
            <div class="rendered-markdown">
                <markdown-renderer :markdown.sync="active.content"></markdown-renderer>
            </div>
        </section>
    ...
    <template id="posts_list_template">
